...
class IsogeoUtils(object):
    ...
    def tags_to_dict(self, tags=dict, prev_query=dict, duplicated: str = "rename"):
        """FORMER METHOD NOW MOVED TO THE TAGS MODULE.
        """
        warnings.warn("Method has been to the tags module.", DeprecationWarning)
        # return the output
        return tags_helpers.tags_to_dict(tags, prev_query, duplicated)
