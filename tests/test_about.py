...
class TestAccount(unittest.TestCase):
    """Test About model of Isogeo API."""
    ...
    def test_account(self):
        """GET :/about/}"""
        # compare about objects
        me = self.isogeo.about.get(caching=0)  # About route
        self.assertIsInstance(me, User)

    def test_account_memberships(self):
        """GET :/about/memberships}"""
        self.isogeo.about.memberships()
